...
public class Leet18 {
    public List<List<Integer>> fourSum(int[] nums, int target) {
        int a = 0, b = 1, c = nums.length - 2, d = nums.length - 1, sum = 0;
        ...
        while (a + 2 < d) {
            ...
            while (a + 2 < d) {
                ...
                while (b < c) {
                    if (nums[b] == nums[b - 1] && nums[c] == nums[c + 1] && !(b == a + 1 && c == d - 1)) {
                        if (sum < target) b++;
                        else c--;
                        continue;
                    }
    ...
    public void run() {
        int[] nums = new int[]{
                ...
                -87994788,3460985,18744871,-49724457,-12982362,-47800372,39958829,-95981751,-71017359,
